  ...
  const values = [
    {
      title: "Clarity",
      description:
        "We make complex ideas easy to understand without oversimplifying.",
    },
    {
      title: "Integrity",
      description:
        "We're honest about what we know and transparent about our sources.",
    },
    {
      title: "Curiosity",
      description:
        "We explore topics deeply and ask the questions our readers care about.",
    },
    {
      title: "Community",
      description:
        "We write for real people, not algorithms, and value reader feedback.",
    },
  ];
