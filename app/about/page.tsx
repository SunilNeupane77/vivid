    ...
    <main className="max-w-3xl mx-auto px-4 py-12 sm:py-16">
      ...
      <section className="mb-16">
        ...
        <div className="space-y-4 text-gray-700">
          <p>
            ...
            Our mission is to create content that&rsquo;s both meaningful and accessible.
          </p>
          <p>
      ...
      <section className="mb-16">
        ...
        <div className="grid sm:grid-cols-2 gap-6">
          {[
            ...
            {
              title: "Integrity",
              description: "We&rsquo;re honest about what we know and transparent about our sources."
            },
            {
              title: "Curiosity",
      ...
      <section className="mb-16">
        ...
        <p className="text-gray-700 mb-6">
          We&rsquo;re a small team of writers and editors committed to creating quality content.
        </p>
